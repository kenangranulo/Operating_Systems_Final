...
Server : Server.o thread.o socket.o socketserver.o Blockable.o black_jack.o
	g++ -o Server Server.o thread.o socket.o socketserver.o Blockable.o black_jack.o -pthread -lrt

Blockable.o : Blockable.h Blockable.cpp
	g++ -c Blockable.cpp -std=c++11

Server.o : Server.cpp thread.h socketserver.h black_jack.h
